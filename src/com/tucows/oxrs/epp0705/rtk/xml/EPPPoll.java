...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epp0705/rtk/xml/EPPPoll.java,v 1.2 2003/04/25 20:39:38 tubadanm Exp $
 * $Revision: 1.2 $
 * $Date: 2003/04/25 20:39:38 $
 */
...
import com.tucows.oxrs.epp0705.rtk.xml.poll.*;
...
public class EPPPoll extends EPPXMLBase implements epp_Poll
{
     ...
     * look in the com.tucows.oxrs.epp0705.rtk.xml.poll package for
     ...
     * "com.tucows.oxrs.epp0705.rtk.xml.poll".  It turns out that this class
     ...
     * @see com.tucows.oxrs.epp0705.rtk.RTKBase#getRTKProperties()
     */
        ...
        try
        {
            ...
            if ( response_data_element != null )
            {
                ...
                for (int count = 0; count < poll_resData_nodelist.getLength(); count++)
                {
                    ...
                    String poll_extension_package_name = "com.tucows.oxrs.epp0705.rtk.xml.poll";
