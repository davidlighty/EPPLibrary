...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epp0503/rtk/xml/EPPPoll.java,v 1.2 2004/01/19 18:47:59 tubadanm Exp $
 * $Revision: 1.2 $
...
import com.tucows.oxrs.epp0503.rtk.xml.poll.*;
...
public class EPPPoll extends EPPXMLBase implements epp_Poll
{
     ...
     * @see com.tucows.oxrs.epp0503.rtk.RTKBase#getRTKProperties()
     */
        ...
        try
        {
            ...
            if ( response_data_element != null )
            {
                ...
                for (int count = 0; count < poll_resData_nodelist.getLength(); count++)
                {
                    ...
                    String poll_extension_package_name = "com.tucows.oxrs.epp0503.rtk.xml.poll";
