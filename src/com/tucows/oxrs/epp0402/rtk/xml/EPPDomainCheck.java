...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epp0402/rtk/xml/EPPDomainCheck.java,v 1.1 2003/03/21 16:35:37 tubadanm Exp $
 * $Revision: 1.1 $
 ...
 * Usage is demonstrated in the com.tucows.oxrs.epp0402.rtk.example.DomainExample
 * class.
 * @see com.tucows.oxrs.epp0402.rtk.example.DomainExample
 * @see org.openrtk.idl.epp0402.epp_Action
 * @see org.openrtk.idl.epp0402.domain.epp_DomainCheck
 * @see org.openrtk.idl.epp0402.domain.epp_DomainCheckReq
 * @see org.openrtk.idl.epp0402.domain.epp_DomainCheckRsp
...
public class EPPDomainCheck extends EPPDomainBase implements epp_DomainCheck
{
     ...
     * @param value org.openrtk.idl.epp0402.epp_DomainCheckReq
     */
     ...
     * @return value org.openrtk.idl.epp0402.epp_DomainCheckRsp
     */
    ...
    public void fromXML(String xml) throws epp_XMLException, epp_Exception
    {
        ...
        try
        {
            ...
            NodeList domain_check_result_list = response_data_element.getElementsByTagName("domain:chkData").item(0).getChildNodes();

            debug(DEBUG_LEVEL_TWO,method_name,"domain:chkData's node count ["+domain_check_result_list.getLength()+"]");

            if ( domain_check_result_list.getLength() == 0 )
            {
            ...
            for (int count = 0; count < domain_check_result_list.getLength(); count++)
            {
                Node a_node = domain_check_result_list.item(count);
