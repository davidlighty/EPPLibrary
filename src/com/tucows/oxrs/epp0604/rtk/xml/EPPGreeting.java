...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epp0604/rtk/xml/EPPGreeting.java,v 1.1 2003/03/21 15:53:01 tubadanm Exp $
 * $Revision: 1.1 $
 * $Date: 2003/03/21 15:53:01 $
 */
 ...
 * @version $Revision: 1.1 $ $Date: 2003/03/21 15:53:01 $
...
public class EPPGreeting extends EPPXMLBase implements epp_Hello
{
     ...
     * @return value org.openrtk.idl.epp0604.epp_Greeting
     */
    ...
    public void fromXML(String xml) throws epp_XMLException, epp_Exception
    {
		...
		epp_DataCollectionPolicy dc_policy = new epp_DataCollectionPolicy();
			...
			if ( recipients_nodes != null )
			{
			    ...
			    dcp_statement.m_recipients = (epp_dcpRecipient[])convertListToArray(epp_dcpRecipientType.class, recipients_list);
			}
