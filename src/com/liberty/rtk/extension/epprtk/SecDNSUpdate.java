...
public class SecDNSUpdate extends EPPXMLBase implements epp_Extension {
	...
	public void setAdd(SecDNSAdd value) {
		add_ = value;
	}
	...
	public void setRem(SecDNSRem value) {
		rem_ = value;
	}
	...
	public void setChg(SecDNSChg value) {
		chg_ = value;
	}
	...
	public String toXML() throws epp_XMLException {
		...
		if (add_ == null && rem_ == null && chg_ == null)
		...
		try {
			...
			throw new epp_XMLException(
					"IOException in building secDNS:update XML ["
							+ xcp.getMessage() + "]");
		}
	...
	/**
	 * This would parse a response from the server with the <secDNS:update>
	 * extension. but <secDNS:update> is only used in the <domain:update>
	 * request.<br>
