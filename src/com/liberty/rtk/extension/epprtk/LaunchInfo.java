...
public class LaunchInfo extends EPPXMLBase implements epp_Extension {
	...
	public Collection<String> getMarks() {
		return marks;
	}
	...
	public String toXML() throws epp_XMLException {
		...
		try {
			...
			throw new epp_XMLException(
					"IOException in building launch:info XML ["
							+ xcp.getMessage() + "]");
		}
	...
	public void fromXML(String xml) throws epp_XMLException {
		...
		try {
			...
			debug(DEBUG_LEVEL_TWO, method_name, "node_list's node count ["
					+ node_list.getLength() + "]");
	...
	public Element toXMLElement(Document doc) throws epp_XMLException {
		...
		if (applicationID != null && !applicationID.isEmpty()) {
			ExtUtils.addXMLElement(doc, e, "launch:applicationID",
					applicationID);
		}
