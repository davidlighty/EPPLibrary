...
public class TrademarkData {
	...
	public void setOwnerCountry(String owner_country) {
		tm_owner_country_ = owner_country;
	}
	...
	public String toString() {
		return "[remove:" + remove + "|name:" + tm_name_ + "|country:"
				+ tm_country_ + "|number:" + tm_number_ + "|date:" + tm_date_
				+ "|regDate:" + tm_reg_date_ + "|appDate:" + tm_app_date_
				+ "|ownerCountry:" + tm_owner_country_;
	}
}
