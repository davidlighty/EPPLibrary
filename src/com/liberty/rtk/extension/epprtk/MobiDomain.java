...
public class MobiDomain extends EPPXMLBase implements epp_Extension {
	 ...
	 * This qualifies the maintainerUrl name of the domain(s) in domain:create
	...
	public String toXML() throws epp_XMLException {
		...
		debug(DEBUG_LEVEL_THREE, method_name,
				"The MobiDomain extension XML is: [" + mobi_xml + "]");
	...
	public void fromXML(String xml) throws epp_XMLException {
		...
		try {
			...
			debug(DEBUG_LEVEL_TWO, method_name, "mobi_node_list's node count ["
					+ mobi_node_list.getLength() + "]");
	...
	protected void setAttribute(Element mobi) {
		...
		mobi.setAttribute("xmlns:xsi",
				"http://www.w3.org/2001/XMLSchema-instance");
		mobi.setAttribute("xsi:schemaLocation",
				"urn:ietf:params:xml:ns:mobi-1.0 mobi-1.0.xsd");
	}
