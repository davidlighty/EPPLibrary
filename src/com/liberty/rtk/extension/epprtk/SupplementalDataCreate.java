...
public class SupplementalDataCreate extends EPPXMLBase implements epp_Extension {
	...
	public String toXML() throws epp_XMLException {
		...
		if (data_ == null || data_.length() == 0)
			throw new epp_XMLException("supplementalData:value invalid ("
					+ data_ + ")");
		...
		try {
			...
			throw new epp_XMLException(
					"IOException in building supplementalData:create XML ["
							+ xcp.getMessage() + "]");
		}
	 ...
	 * <supplementalData:create> extension. Implemented method from
