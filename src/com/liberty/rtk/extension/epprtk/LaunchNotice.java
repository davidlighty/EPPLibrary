...
public class LaunchNotice {
	...
	public Element getElement(Document doc) throws epp_XMLException {
		...
		if (noticeID == null || noticeID.isEmpty())
			throw new epp_XMLException("launch:noticeID invalid (" + noticeID
					+ ")");
		if (notAfter == null || notAfter.isEmpty())
			throw new epp_XMLException("launch:notAfter invalid (" + notAfter
					+ ")");
		if (acceptedDate == null || acceptedDate.isEmpty())
			throw new epp_XMLException("launch:acceptedDate invalid ("
					+ acceptedDate + ")");
	...
	public String toString() {
		return "[noticeID:" + noticeID + "|notAfter:" + notAfter
