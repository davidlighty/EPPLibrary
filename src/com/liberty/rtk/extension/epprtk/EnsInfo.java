...
public class EnsInfo {
	...
	public EnsInfo(Collection ens_class, String ens_org,
			String registrant_group, String request_type,
			String registration_type, String credentials_type,
			String credentials_value, String code_value,
			String unique_identifier, String last_checked_date) {
	...
	public void setEnsClass(Collection ensClass) {
		ens_class_ = ensClass;
	}
	...
	public void setRegistrantGroup(String registrantGroup) {
		registrant_group_ = registrantGroup;
	}

	public String getRegistrantGroup() {
		return registrant_group_;
	}
	...
	public void setCredentialsType(String credentialsType) {
		credentials_type_ = credentialsType;
	}
	...
	public void setCredentialsValue(String cdentialsValue) {
		credentials_value_ = cdentialsValue;
	}

	public String getCredentialsValue() {
		return credentials_value_;
	}
	...
	public void setUniqueIdentifier(String uniqueIdentifier) {
		unique_identifier_ = uniqueIdentifier;
	}
	...
	public String toString() {
		return "[ensClass: " + ens_class_ + "|ensO: " + ens_org_
				+ "|registrantGroup: " + registrant_group_ + "|requestType: "
				+ request_type_ + "|registrationType: " + registration_type_
				+ "|credentialsType: " + credentials_type_ + "|cdentialsValue:"
				+ credentials_value_ + "|codeValue: " + code_value_
				+ "|uniqueIdentifier: " + unique_identifier_
				+ "|lastCheckedDate: " + last_checked_date_ + "]";
	}
}
