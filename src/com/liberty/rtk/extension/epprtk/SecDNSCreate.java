...
public class SecDNSCreate extends EPPXMLBase implements epp_Extension {
	...
	public String toXML() throws epp_XMLException {
		...
		try {
			...
			throw new epp_XMLException(
					"IOException in building secDNS:create XML ["
							+ xcp.getMessage() + "]");
		}
	...
	/**
	 * This would parse a response from the server with the <secDNS:create>
	 * extension. but <secDNS:create> is only used in the <domain:create>
	 * request.<br>
	...
	public Element toXMLElement(Document doc) throws epp_XMLException {
		...
		for (Iterator it = ds_data_.iterator(); it.hasNext();)
