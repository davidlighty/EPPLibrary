...
public class AeroContactN extends AeroBase {
	...
	public String toXML() throws epp_XMLException {
		...
		debug(DEBUG_LEVEL_THREE, method_name,
				"The MobiDomain extension XML is: [" + aero_xml + "]");
	...
	public Element toXMLElement(Document doc) throws epp_XMLException {
		...
		if (maintainerUrl_ != null) {
			if (command_.equals("create")) {
				ExtUtils.addXMLElement(doc, aero, "aero:maintainerUrl",
						maintainerUrl_);
			} else if (command_.equals("update")) {
				Element chg = doc.createElement("aero:chg");
				ExtUtils.addXMLElement(doc, chg, "aero:maintainerUrl",
						maintainerUrl_);
