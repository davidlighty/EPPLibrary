...
public class IprData {
	...
	public void setAppDate(String appDate) {
		ipr_app_date_ = appDate;
	}

	public String getAppDate() {
		return ipr_app_date_;
	}

	public void setRegDate(String regDate) {
		ipr_reg_date_ = regDate;
	}

	public String getRegDate() {
		return ipr_reg_date_;
	}

	public void setIprClass(String my_class) {
		ipr_class_ = my_class;
	}
	...
	public void setEntitlement(String value) {
		ipr_entitlement_ = value;
	}

	public String getEntitlement() {
		return ipr_entitlement_;
	}
	...
	public void setPreVerified(String value) {
		ipr_preVerified_ = value;
	}

	public String getPreVerified() {
		return ipr_preVerified_;
	}

	public String toString() {
		return "[name:" + ipr_name_ + "|ccLocality:" + ipr_country_
				+ "|number:" + ipr_number_ + "|regDate:" + ipr_reg_date_
				+ "|appDate:" + ipr_app_date_ + "|class:" + ipr_class_
				+ "|entitlement:" + ipr_entitlement_ + "|form:" + ipr_form_
				+ "|type:" + ipr_type_ + "|PreVerified:" + ipr_preVerified_
				+ "]";
	}
}
