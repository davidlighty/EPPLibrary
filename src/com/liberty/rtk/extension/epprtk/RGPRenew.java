...
public class RGPRenew extends EPPXMLBase implements epp_Extension {
	...
	/**
	 * Converts the rgp renew data into XML to be put into the extension section
	 * of the request. Implemented method from
	...
	public String toXML() throws epp_XMLException {
		...
		rgp_renew.setAttribute("xmlns:xsi",
				"http://www.w3.org/2001/XMLSchema-instance");
		rgp_renew.setAttribute("xsi:schemaLocation",
				"urn:EPP:xml:ns:ext:rgp-1.0 rgp-1.0.xsd");
		...
		debug(DEBUG_LEVEL_THREE, method_name,
				"The rgp renew extension XML is: [" + rgp_renew_xml + "]");
	...
	/**
	 * Parses an XML String of rgp renew data from the extension section of a
	 * response from the Registry. Implemented method from
	 * org.openrtk.idl.epprtk.epp_Extension interface.
	 * 
	 * @param A
	 *            new rgp renew Extension XML String to parse
	 * @throws org.openrtk.idl.epprtk.epp_XMLException
