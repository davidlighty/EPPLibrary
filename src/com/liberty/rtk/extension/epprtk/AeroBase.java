...
public abstract class AeroBase extends EPPXMLBase implements epp_Extension {
	...
	/**
	 * Accessor method for the EPP command for this AeroBase extension. Typical
	...
	protected void setAeroAttribute(Element aero) {
		...
		aero.setAttribute("xmlns:xsi",
				"http://www.w3.org/2001/XMLSchema-instance");
		aero.setAttribute("xsi:schemaLocation",
				"urn:ietf:params:xml:ns:aero-1.0 aero-1.0.xsd");
	}
