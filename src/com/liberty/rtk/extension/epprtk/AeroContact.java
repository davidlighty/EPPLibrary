...
public class AeroContact extends AeroBase {
	...
	public void setRegistrantGroup(String registrantGroup) {
		registrantGroup_ = registrantGroup;
	}

	public String getRegistrantGroup() {
		return registrantGroup_;
	}
	...
	public void setCredentialsType(String credentialsType) {
		credentialsType_ = credentialsType;
	}
	...
	public void setCredentialsValue(String credentialsValue) {
		credentialsValue_ = credentialsValue;
	}

	public String getCredentialsValue() {
		return credentialsValue_;
	}
	...
	public void setLastCheckedDate(String lastCheckedDate) {
		lastCheckedDate_ = lastCheckedDate;
	}
	...
	/**
	 * Contact create, update and delete operations restrited to SITA normal
	 * user can only use contact info command, which does not need this
	 * extension.
	 * 
