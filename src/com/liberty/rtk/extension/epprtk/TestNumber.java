...
/**
 * This class is used to exchange Registrar Certification Test Number data with
 * the Liberty .info Registry. The data should only be used in the OT&E
 * environment and only during a registrar cerfication test.
 * 
...
public class TestNumber extends EPPXMLBase implements epp_Extension {
	...
	/**
	 * Accessor method for the test number data member. Normally in the format
	 * of "2.2.14"
	 * 
	 * @param value
	 *            The test number
	...
	public String toXML() throws epp_XMLException {
		...
		Element testnum = toXMLElement(doc);
	...
	/**
	 * Parses an XML String of test number data from the extension section of a
	 * response from the Registry. Implemented method from
	 * org.openrtk.idl.epprtk.epp_Unspec interface.
	 * 
	 * @param A
	 *            new test number Unspec XML String to parse
	 * @throws org.openrtk.idl.epprtk.epp_XMLException
	 *             if the response XML is not parsable or does not contain the
	 *             expected data
